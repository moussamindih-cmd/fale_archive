...
class ReceiptPdfService {
  static Future<Uint8List> generateReceiptPdf({
    ...
    final invoiceNumber =
        'INV-${transaction.createdAt.year}${transaction.createdAt.month.toString().padLeft(2, '0')}-${transaction.id.substring(0, 8).toUpperCase()}';
                ...
                children: [
                  pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text(
                        'Plateforme SaaS de GED & GAE Multi-Tenant',
                        style: pw.TextStyle(
                          fontSize: 10,
                ...
                children: [
                  pw.Column(
                    ...
                    children: [
                      ...
                      pw.SizedBox(height: 4),
                      pw.Text(
                        'N° Téléphone : +235 ${transaction.phoneNumber}',
                        style: const pw.TextStyle(fontSize: 10),
                      ),
                    ],
                  ),
                  pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text(
                        'Opérateur : ${transaction.operator.label}',
                        style: const pw.TextStyle(fontSize: 10),
                      ),
                      if (transaction.transactionReference != null)
                        pw.Text(
                          'Réf. CinetPay : ${transaction.transactionReference}',
                          style: const pw.TextStyle(fontSize: 10),
                        ),
                    ],
                  ),
                    ...
                    children: [
                      pw.Padding(
                        ...
                        child: pw.Column(
                          ...
                          children: [
                            pw.Text(
                              'Abonnement FALE ARCHIVES - Formule ${transaction.planName}',
                              style: pw.TextStyle(
                                fontWeight: pw.FontWeight.bold,
                                fontSize: 11,
                              ),
                            ...
                            pw.SizedBox(height: 4),
                            pw.Text(
                              'Accès complet aux modules GED/GAE conformément à la formule souscrite.',
                              style: pw.TextStyle(
                                fontSize: 9,
                                color: PdfColor.fromHex('#64748B'),
                              ),
              ...
              pw.Row(
                ...
                children: [
                  pw.Column(
                    ...
                    children: [
                      pw.Text(
                        'Statut : PAIEMENT CONFIRMÉ & VALIDÉ',
                        style: pw.TextStyle(
                          fontWeight: pw.FontWeight.bold,
                          fontSize: 10,
                      ...
                      pw.Text(
                        'Ce document fait office de quittance et de facture officielle.',
                        style: pw.TextStyle(
                          fontSize: 8,
                  ...
                  pw.BarcodeWidget(
                    ...
                    data:
                        'FALE-ARCHIVES-VERIF:$invoiceNumber:${transaction.amount}:${transaction.operator.name}',
                    width: 50,
                    height: 50,
                  ),
                ],
