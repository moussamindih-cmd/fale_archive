        ...
        child: Column(
          ...
          children: [
            ...
            if (status == SubscriptionStatus.pending) ...[
              ...
              Text('Vérification automatique toutes les 8 secondes',
                  style: GoogleFonts.outfit(
                  ...
                  child: GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: selected ? opColor : kBorderColor,
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        padding: const EdgeInsets.all(20),
        decoration: BoxDecoration(
          color: isSelected ? planColor.withValues(alpha: 0.05) : kSurface,
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
            color: isSelected ? planColor : kBorderColor,
                ...
                Expanded(
                  child: Text(plan.name,
                      style: GoogleFonts.outfit(
                          fontSize: 18,
                          fontWeight: FontWeight.w800,
                          color: isSelected ? planColor : kTextPrimary)),
                ),
                if (isSelected)
                  Container(
                    padding: const EdgeInsets.all(4),
                    decoration: BoxDecoration(
                        color: planColor, shape: BoxShape.circle),
            ...
            Row(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text('/ ${plan.durationDays} jours',
                      style: GoogleFonts.outfit(
                          fontSize: 13,
                          color: kTextSecondary,
                          fontWeight: FontWeight.w500)),
                ...
                return Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(SubscriptionPlan.featureLabel(f),
                          style: GoogleFonts.outfit(
                              fontSize: 11,
                              fontWeight: FontWeight.w600,
                              color: planColor)),
