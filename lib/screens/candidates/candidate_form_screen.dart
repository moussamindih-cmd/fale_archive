  ...
  Future<void> _handleSubmit() async {
    ...
    if (_selectedPosition == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        _snackBar('Veuillez sélectionner le poste visé.', const Color(0xFFF59E0B)),
      );
      return;
    }
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      _snackBar(
        _isEditing ? 'Dossier candidat mis à jour !' : 'Candidat ajouté avec succès !',
          ...
          child: Column(
            ...
            children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        maxLines: 3,
                        decoration: const InputDecoration(
                          hintText: 'Compétences, observations, disponibilités...',
                        ),
                      ),
                    ],
                  ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          _label('Documents (CV, pièces...)'),
                          if (_documents.isNotEmpty)
                            Text('${_documents.length} fichier(s)',
                              style: GoogleFonts.outfit(fontSize: 12, color: const Color(0xFFEC4899), fontWeight: FontWeight.w700)),
                        ],
                      ),
                      const SizedBox(height: 12),
                      ..._documents.asMap().entries.map((e) => DocumentPreview(
                        file: e.value,
                        onRemove: () => setState(() => _documents.removeAt(e.key)),
                      )),
                      OutlinedButton.icon(
              ...
              ElevatedButton.icon(
                ...
                label: Text(_isEditing ? 'Enregistrer les modifications' : 'Créer le dossier candidat'),
