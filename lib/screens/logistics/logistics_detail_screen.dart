...
class _LogisticsDetailScreenState extends State<LogisticsDetailScreen> {
  ...
  LogisticsState get logisticsState => widget.logisticsState;
  String get currentUserName => widget.currentUserName;
  UserRole get currentUserRole => widget.currentUserRole;

  bool get _canValidate =>
      currentUserRole.hasPermission(FalePermission.validateLogistics);
  bool get _canEdit =>
      currentUserRole == UserRole.employe || currentUserRole == UserRole.admin;

  @override
  void initState() {
    super.initState();
    logisticsState.loadHistory(itemId);
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Ce document est en attente de votre validation.',
                style: GoogleFonts.outfit(
                  fontSize: 13,
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () {
                      logisticsState.validateItem(
                        id: item.id,
                        validatorName: currentUserName,
                      );
